package com.krm.tmdb.ui.widget
...
class TouchImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : AppCompatImageView(context, attrs, defStyle) {
    ...
    internal var onTouchListener: View.OnTouchListener? = null
    ...
    private class ZoomVariables internal constructor(internal val scale: Float, internal val focusX: Float, internal val focusY: Float, internal val scaleType: ImageView.ScaleType)
