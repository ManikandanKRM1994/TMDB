 ...
 */
open class BaseInteractor<V : InterfaceView> @Inject constructor(private var supportFragment: FragmentManager, private var context: Context, private val api: NewsApi) :
    InterfaceInteractor<V> {
